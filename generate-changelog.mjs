...
<head>
  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .navlinks a:hover { color: var(--crema); }
...
${entries}
    <footer>© ${new Date().getUTCFullYear()} Rich Sharples · <a href="./">pullbook.app</a> · <a href="./roadmap.html">Roadmap</a> · <a href="./feedback.html">Feedback</a></footer>
  </div>
</body>
</html>
`;
